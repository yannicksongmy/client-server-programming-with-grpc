...
In this project, the server is coded in Java and the client is coded in Python, and we have also standard request/response and bidirectionnal streaming. The poal is to factorize the numbers given by the client and to display the results.
